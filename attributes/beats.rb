...
default['mconf-stats']['beats']['apt']['uri']           = 'https://packages.elastic.co/beats/apt'
...
default['mconf-stats']['beats']['apt']['key']           = 'https://packages.elasticsearch.org/GPG-KEY-elasticsearch'
